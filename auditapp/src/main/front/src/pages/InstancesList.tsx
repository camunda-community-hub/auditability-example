...
function InstancesList() {
  ...
  const loadXmlDefinition = async () => {
    if (processDef && processDef.defKey) {
      setXml(await processService.getDefinition(processDef.defKey));
    }
  }
            ...
            <Table striped bordered hover>
              ...
              <tbody>
                {instances ? instances.map((instance: any) =>
                  <tr key={instance.processInstanceKey}>
                    <td><Link to={"/admin/instance/" + instance.processInstanceKey} >{instance.processInstanceKey}</Link></td>
